...
public class CertificateAuthorityActivityPanel extends JPanel {
    ...
    public CertificateAuthorityActivityPanel(CertificateAuthority ca) {
        _ca = ca;

        try {
            componentInit();
        } catch (Exception e) {
            System.out.println("CertificateAuthorityActivity error: " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    void componentInit() throws Exception {
        ...
        addLabel(gridBag, "CA Activity: ", SwingConstants.LEFT, 0, 0, 1, 1);
